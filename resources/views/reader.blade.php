...
<div class="reader-container" id="reader">
    ...
    <div class="reader-header" id="readerHeader">
        <div class="reader-header__left">
            <a href="{{ route('manga.detail', $manga->slug) }}" class="btn-icon" title="Back to Manga">
        ...
        <div class="reader-header__right">
            <div class="nav-group">
                @if($prevChapter)
                    <a href="{{ route('chapter.read', [$manga->slug, $prevChapter->chapter_number]) }}" class="btn-nav" title="Previous Chapter">
                ...
                <div class="custom-dropdown" id="chapterDropdown">
                    <button class="dropdown-trigger" onclick="toggleChapterDropdown()">
                        <span class="current-chapter">Chapter {{ $chapter->chapter_number }}</span>
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="dropdown-items custom-scrollbar">
                            @foreach($allChapters as $ch)
                                <a href="{{ route('chapter.read', [$manga->slug, $ch->chapter_number]) }}" 
                                   class="dropdown-item {{ $ch->chapter_number == $chapter->chapter_number ? 'active' : '' }}"
                                   data-val="{{ $ch->chapter_number }}">
                ...
                @if($nextChapter)
                    <a href="{{ route('chapter.read', [$manga->slug, $nextChapter->chapter_number]) }}" class="btn-nav" title="Next Chapter">
    ...
    <div class="reader-content" id="readerImages" onclick="toggleHeader()">
        @forelse($pages as $index => $imageUrl)
        ...
        @empty
            <div class="empty-state-reader">
                ...
                <div class="empty-actions">
                     ...
                     <a href="{{ route('manga.detail', $manga->slug) }}" class="btn btn--outline">Back to Manga</a>
                </div>
            </div>
        @endforelse
    </div>
    ...
    <div class="reader-footer">
        <div class="nav-buttons-large">
            @if($prevChapter)
                <a href="{{ route('chapter.read', [$manga->slug, $prevChapter->chapter_number]) }}" class="btn-large prev">
                    <span class="label">Previous Chapter</span>
                    <span class="val">Chapter {{ $prevChapter->chapter_number }}</span>
                </a>
            @else
            ...
            @if($nextChapter)
                <a href="{{ route('chapter.read', [$manga->slug, $nextChapter->chapter_number]) }}" class="btn-large next">
                    <span class="label">Next Chapter</span>
                    <span class="val">Chapter {{ $nextChapter->chapter_number }}</span>
                </a>
            @else
                <a href="{{ route('manga.detail', $manga->slug) }}" class="btn-large finish">
